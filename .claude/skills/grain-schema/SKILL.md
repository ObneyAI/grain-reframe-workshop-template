...
- `components/user-service/src/app/user_service/interface/schemas.clj` - User schemas
- `components/crm-service/src/app/crm_service/interface/schemas.clj` - CRM schemas with custom types
