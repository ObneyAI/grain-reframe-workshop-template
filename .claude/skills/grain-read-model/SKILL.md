...
- `components/user-service/src/app/user_service/core/read_models.clj` - User projections
- `components/crm-service/src/app/crm_service/core/read_models.clj` - CRM projections
